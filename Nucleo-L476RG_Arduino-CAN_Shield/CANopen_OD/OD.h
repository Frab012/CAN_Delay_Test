...
********************************************************************************
    ...
    File info:
        ...
        Project File: project_l476rg.xdd
        File Version: 1

        Created:      18.2.2025 11:07:19
        Created By:   
        Modified:     12.8.2026 10:53:11
        Modified By:  

    Device Info:
        Vendor Name:  None
        Vendor ID:    0
        Product Name: Nucleo-L476RG
        Product ID:   0
...
#define OD_CNT_ARR_2100 1
#define OD_CNT_ARR_2101 3
#define OD_CNT_ARR_2102 3
...
typedef struct {
    ...
    uint8_t x2100_deviceObject0_sub0;
    char x2100_deviceObject0[OD_CNT_ARR_2100][33];
    uint8_t x2101_deviceObject1_sub0;
    uint8_t x2101_deviceObject1[OD_CNT_ARR_2101];
    uint8_t x2102_deviceObject2_sub0;
    uint8_t x2102_deviceObject2[OD_CNT_ARR_2102];
} OD_RAM_t;
...
#define OD_ENTRY_H2100 &OD->list[22]
#define OD_ENTRY_H2101 &OD->list[23]
#define OD_ENTRY_H2102 &OD->list[24]
...
#define OD_ENTRY_H1029_errorBehaviorObject &OD->list[15]
...
#define OD_ENTRY_H2100_deviceObject0 &OD->list[22]
#define OD_ENTRY_H2101_deviceObject1 &OD->list[23]
#define OD_ENTRY_H2102_deviceObject2 &OD->list[24]
